...
<div class="row">
	...
	?>
				<div class="col-xl-2 col-md-4 col-6 mb-4"data-aos="zoom-in">
					<div class="card">
						<img src="./assets/img/hong.png" width="100px" class="card-img-top" alt="Máy đang gặp sự cố">
						<div class="card-body">
				...
				?>
						<div class="col-xl-2 col-md-4 col-6 mb-4" data-aos="zoom-in">
							<a class="card" href="./ql-giao-dich.php?may=<?= $maytinh['id'] ?>">
								<img src="./assets/img/usecom.jpg" width="100px" class="card-img-top" alt="máy đang sử dụng">
								<div class="card-body">
					...
					?>
						<div class="col-xl-2 col-md-4 col-6 mb-4" data-aos="zoom-in">
							<a class="card text-center" href="./them-giao-dich.php?may=<?= $maytinh['id'] ?>">
								<img src="./assets/img/com.png" width="100px" class="card-img-top" alt="máy trống">
								<div class="card-body">
									<p class="font-weight-bold text-primary text-center"><?= $maytinh['tenmay'] ?></p>
