    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center">
          <h1 class="logo mr-auto"><a href="index.php">Nasa</a></h1>

          <nav class="nav-menu d-none d-lg-block">
            <ul id="menuHeader">
              <li><a href="./index.php" data="index">Trang chủ</a></li>
              <li><a href="./ql-khach-hang.php" data="ql-khach-hang">QL khách hàng</a></li>
              <li><a href="./ql-may-tinh.php" data="ql-may-tinh">QL Computer</a></li>
